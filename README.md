...
2. Get Lightwave to accept an exported FBX format 3D Asset and automaticaly set up LW native PBSDF surfaces(1)
    - Add Octane surfaces to the options.  
...
## Advanced Plans for future versions: 

1. Adding a user manageable surface template library for glass, liquids, layered or other specialized surfacing needs.  
2. Integration with OD/Pro-tool Object presets and LW native surface presets
3. Advanced lighting / atlas / illuminated surfaces or object parts 
   

### footnotes: 
(1) - Some material types are either deprecated or too specific to be reasonably handled by this plugin/script at this time.   Megascans is a PBR based collection of assets and I intend to focus on PBSDF and Octane surfacing for now.   
